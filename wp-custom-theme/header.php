...
<head>
    ...
    if (is_front_page()):
        ?>
        <title>Accueil | <?php bloginfo( 'BritCom' ); ?></title>
        <?php
    else:
        ?>
...
?>
    ...
    <!-- VERSION STATIQUE ECRIT A LA MANO -->
    ...
    <!-- <nav>
        <ul>
            ...
            <li>
                <a href="/category/channel-4">Channel 4</a>
            </li>
            <li>
                <a href="/category/sketch-show">Sketch Show</a>
            </li>
            <li>
                <a href="/tag/rikmayall">Rik Mayall</a>
            </li>            
            <li>
                <a href="/tag/stevecoogan">Steve Coogan</a>
            </li>
        </ul>
    </nav> -->
